    ...
    public static void main(String[] args) {
        ...
        if (pilihanFormat == 1) {
            ...
            for (int i = 0; i < csp.jmlTipe; i++) {
                ...
                int angkaTipe = scan.nextInt();
                if(angkaTipe == i){
                    System.out.println("Untuk mobil tipe " + csp.tipeMobil[angkaTipe] + ": ");
                }
                else{
                    System.out.println("MOHON ISI BERDASARKAN URUTAN");
                    System.exit(0);
                }
