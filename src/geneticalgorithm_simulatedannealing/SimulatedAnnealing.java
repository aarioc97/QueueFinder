 ...
 */
package geneticalgorithm_simulatedannealing;
...
public class SimulatedAnnealing {
    ...
    private int /*temperatureCounter,*/ initialTemp, selisihTemp, repetitionSch, selisihFitness;
    ...
    public void inisialisasiVariabel(Kromosom[] initPop) {
        ...
        this.selisihTemp = this.rn.nextInt(9) + 1 /*10*/;
